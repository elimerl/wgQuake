...
#define GAMEPAD_KEY_LIST(def)                                                  \
  ...
  def(K_START, = K_GAMEPAD_BEGIN, "MENU", "OPTIONS",                           \
      "+") def(K_BACK, /*auto*/, "VIEW", "CREATE",                             \
               "-") def(K_LTHUMB, /*auto*/, "LS", "L3",                        \
                        "LSB") def(K_RTHUMB, /*auto*/, "RS", "R3", "RSB")      \
      def(K_LSHOULDER, /*auto*/, "LB", "L1",                                   \
          "L") def(K_RSHOULDER, /*auto*/, "RB", "R1",                          \
                   "R") def(K_DPAD_UP, /*auto*/, "DPAD UP", "DPAD UP",         \
                            "DPAD UP") def(K_DPAD_DOWN, /*auto*/, "DPAD DOWN", \
                                           "DPAD DOWN", "DPAD DOWN")           \
          def(K_DPAD_LEFT, /*auto*/, "DPAD LEFT", "DPAD LEFT", "DPAD LEFT")    \
              def(K_DPAD_RIGHT, /*auto*/, "DPAD RIGHT", "DPAD RIGHT",          \
                  "DPAD RIGHT") def(K_ABUTTON, /*auto*/, "A", "X", "A")        \
                  def(K_BBUTTON, /*auto*/, "B", "CIRCLE",                      \
                      "B") def(K_XBUTTON, /*auto*/, "X", "SQUARE", "X")        \
                      def(K_YBUTTON, /*auto*/, "Y", "TRIANGLE",                \
                          "Y") def(K_LTRIGGER, /*auto*/, "LT", "L2", "ZL")     \
                          def(K_RTRIGGER, /*auto*/, "RT", "R2", "ZR")          \
                              def(K_MISC1, /*auto*/, NULL, "MUTE", "CAPTURE")  \
                                  def(K_PADDLE1, /*auto*/, "P1 PADDLE", NULL,  \
                                      NULL) def(K_PADDLE2, /*auto*/,           \
                                                "P2 PADDLE", NULL, NULL)       \
                                      def(K_PADDLE3, /*auto*/, "P3 PADDLE",    \
                                          NULL, NULL)                          \
                                          def(K_PADDLE4, /*auto*/,             \
                                              "P4 PADDLE", NULL, NULL)         \
                                              def(K_TOUCHPAD, /*auto*/, NULL,  \
                                                  "TOUCHPAD", NULL)
