...
typedef enum {
  ...
  // TEXPREF_NEAREST and TEXPREF_LINEAR aren't supposed to be ORed with
  // TEX_MIPMAP
  ...
  TEXPREF_ALPHABRIGHT = 0x4000, // use palette with lighting mask in alpha
                                // channel (0=fullbright, 1=lit)
