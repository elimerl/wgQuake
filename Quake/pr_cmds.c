...
static builtin_t pr_builtin[] = {
    ...
    PF_Fixme, // void draw_point (vector point, float colormap, float lifetime,
              // float depthtest) = #81
    PF_Fixme, // void draw_line (vector start, vector end, float colormap, float
              // lifetime, float depthtest) = #82
    ...
    PF_Fixme, // void draw_bounds (vector min, vector max, float colormap, float
              // lifetime, float depthtest) = #86
    PF_Fixme, // void draw_worldtext (string s, vector origin, float size, float
              // lifetime, float depthtest) = #87
