...
float S_GetLoFreqLevel(void) { return snd_lofreqlevel; }

float S_GetHiFreqLevel(void) { return snd_hifreqlevel; }
...
void S_PaintChannels(int endtime) {
  ...
  while (paintedtime < endtime) {
    ...
    if (sndspeed.value == 11025 && shm->speed == 44100) {
      ...
      S_LowpassFilter(((int *)paintbuffer) + 1, 2, end - paintedtime,
                      &memory_r);
    }
