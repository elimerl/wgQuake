...
int UDP_Connect(sys_socket_t socketid, struct qsockaddr *addr) { return 0; }
...
int UDP_Read(sys_socket_t socketid, byte *buf, int len,
             struct qsockaddr *addr) {
...
int UDP_Write(sys_socket_t socketid, byte *buf, int len,
              struct qsockaddr *addr) {
  int ret;
