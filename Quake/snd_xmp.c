...
static qboolean S_XMP_CodecInitialize(void) { return true; }

static void S_XMP_CodecShutdown(void) {}

#if (XMP_VERCODE >= 0x040500)
static unsigned long xmp_fread(void *dest, unsigned long len,
                               unsigned long nmemb, void *f) {
...
static long xmp_ftell(void *f) { return FS_ftell((fshandle_t *)f); }
#endif
...
static int S_XMP_CodecReadStream(snd_stream_t *stream, int bytes,
                                 void *buffer) {
  int r;
